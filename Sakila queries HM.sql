...
ALTER TABLE actor 
ADD COLUMN description BLOB; -- Storage Required L + 2 bytes, where L < 2EXP16
...
SELECT first_name, last_name, sum(amount) AS "August 2005 Total Amount"
FROM staff
INNER JOIN payment 
...
CREATE VIEW top5_revenue_by_genre AS
...
SELECT * FROM top5_revenue_by_genre;
-- 8c. You find that you no longer need the view top_five_genres. Write a query to delete it.
DROP VIEW top5_revenue_by_genre;
